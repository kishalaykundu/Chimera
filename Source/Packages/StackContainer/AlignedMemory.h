 ...
 * @section DESCRIPTION
 * AlignedMemory is a POD type that gives you a portable way to
 * specify static or local stack data of a given alignment and size.
 * For example, if you need static storage for a class, but you want
 * manual control over when the object is constructed and destructed
 * (you don't want static initialization and destruction), use
 * AlignedMemory:
 *
